# Python-Programming-for-Geoscience-A-Journey-from-Scratch
...
- Step-by-step tutorials, hands-on coding sessions, and conceptual explanations.

# Who should this be useful for?

- Geoscience and petroleum engineering students
- Fresh graduates looking to add Python to their skillset
- Professionals in exploration, subsurface and different geoscience roles.

# Each session includes: 
- A dedicated video tutorial
- Accompanying PDF slides or notebooks (linked in each video description)
- Hands-on practice for beginners


# Youtube Playlist link:
https://www.youtube.com/playlist?list=PLQ-EF048S6XvYiOYuD_r2yBg_PcRn31LA
